...
|---|---|---|---|---|
| **v1.1.0** | 1 | 14.2.x | none yet — additive capability, no consumer repinned in this package (`netyvee/app#344` F2-B0); `NavLink.children` is unset everywhere live, so output is byte-identical for every current consumer | ✅ **current** |
